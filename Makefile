CC ?= gcc
TARGETS = mod-memset mod-memset-cpu0 mod-memset-cpu1 mod-memset-internal mod-memset-internal-noopt
...
mod-memset-cpu0: mod-memset.c
	$(CC) $< -std=gnu11 -O3 -Wall -o $@ -DMOD_MEMSET_CPUSET=0
